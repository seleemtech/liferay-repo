...
import com.prime.data.service.service.SalaryRangeService;
import com.prime.data.service.service.SalaryRangeServiceUtil;
...
/**
 * Provides the base implementation for the salary range remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.SalaryRangeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.SalaryRangeServiceImpl
 * @generated
 */
public abstract class SalaryRangeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SalaryRangeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SalaryRangeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SalaryRangeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SalaryRangeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		salaryRangeService = (SalaryRangeService)aopProxy;

		_setServiceUtilService(salaryRangeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SalaryRangeService.class.getName();
	}
	...
	private void _setServiceUtilService(SalaryRangeService salaryRangeService) {
		try {
			Field field = SalaryRangeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, salaryRangeService);
		}
	...
	@Reference
	protected com.prime.data.service.service.SalaryRangeLocalService
		salaryRangeLocalService;

	protected SalaryRangeService salaryRangeService;
