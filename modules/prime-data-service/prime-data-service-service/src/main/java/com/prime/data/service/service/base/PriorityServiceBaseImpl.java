...
import com.prime.data.service.service.PriorityService;
import com.prime.data.service.service.PriorityServiceUtil;
...
/**
 * Provides the base implementation for the priority remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.PriorityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.PriorityServiceImpl
 * @generated
 */
public abstract class PriorityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PriorityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PriorityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PriorityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PriorityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		priorityService = (PriorityService)aopProxy;

		_setServiceUtilService(priorityService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PriorityService.class.getName();
	}
	...
	private void _setServiceUtilService(PriorityService priorityService) {
		try {
			Field field = PriorityServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, priorityService);
		}
	...
	@Reference
	protected com.prime.data.service.service.PriorityLocalService
