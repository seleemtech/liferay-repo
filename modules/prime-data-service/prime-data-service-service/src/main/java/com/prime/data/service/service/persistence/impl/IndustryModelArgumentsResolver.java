...
/**
 * The arguments resolver class for retrieving value from Industry.
 *
...
@Component(
	immediate = true,
	service = {IndustryModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class IndustryModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= industryModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return IndustryImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return IndustryTable.INSTANCE.getTableName();
	}
