...
import com.prime.data.service.service.HighQualHeldService;
import com.prime.data.service.service.HighQualHeldServiceUtil;
...
/**
 * Provides the base implementation for the high qual held remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.HighQualHeldServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.HighQualHeldServiceImpl
 * @generated
 */
public abstract class HighQualHeldServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HighQualHeldService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HighQualHeldService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HighQualHeldServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HighQualHeldService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		highQualHeldService = (HighQualHeldService)aopProxy;

		_setServiceUtilService(highQualHeldService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HighQualHeldService.class.getName();
	}
	...
	private void _setServiceUtilService(
		HighQualHeldService highQualHeldService) {

		try {
			Field field = HighQualHeldServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, highQualHeldService);
		}
	...
	@Reference
	protected com.prime.data.service.service.HighQualHeldLocalService
		highQualHeldLocalService;

	protected HighQualHeldService highQualHeldService;
