...
import com.prime.data.service.service.SkillSetService;
import com.prime.data.service.service.SkillSetServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.SkillSetServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.SkillSetServiceImpl
 * @generated
 */
public abstract class SkillSetServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SkillSetService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SkillSetService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SkillSetServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(skillSetService);
	}
	...
	private void _setServiceUtilService(SkillSetService skillSetService) {
		try {
			Field field = SkillSetServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, skillSetService);
		}
	...
	@Reference
	protected com.prime.data.service.service.SkillSetLocalService
