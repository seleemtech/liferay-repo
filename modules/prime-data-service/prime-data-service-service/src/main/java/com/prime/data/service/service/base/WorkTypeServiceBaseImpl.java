...
import com.prime.data.service.service.WorkTypeService;
import com.prime.data.service.service.WorkTypeServiceUtil;
...
/**
 * Provides the base implementation for the work type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.WorkTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.WorkTypeServiceImpl
 * @generated
 */
public abstract class WorkTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WorkTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workTypeService = (WorkTypeService)aopProxy;

		_setServiceUtilService(workTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(WorkTypeService workTypeService) {
		try {
			Field field = WorkTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, workTypeService);
		}
	...
	@Reference
	protected com.prime.data.service.service.WorkTypeLocalService
