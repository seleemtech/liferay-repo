...
import com.prime.data.service.service.WorkExperienceService;
import com.prime.data.service.service.WorkExperienceServiceUtil;
...
/**
 * Provides the base implementation for the work experience remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.WorkExperienceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.WorkExperienceServiceImpl
 * @generated
 */
public abstract class WorkExperienceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkExperienceService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkExperienceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WorkExperienceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkExperienceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workExperienceService = (WorkExperienceService)aopProxy;

		_setServiceUtilService(workExperienceService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkExperienceService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = WorkExperienceServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, workExperienceService);
		}
	...
	@Reference
	protected com.prime.data.service.service.WorkExperienceLocalService
