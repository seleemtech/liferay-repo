...
import com.prime.data.service.service.CurrJobTitleService;
import com.prime.data.service.service.CurrJobTitleServiceUtil;
...
/**
 * Provides the base implementation for the curr job title remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.CurrJobTitleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.CurrJobTitleServiceImpl
 * @generated
 */
public abstract class CurrJobTitleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CurrJobTitleService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CurrJobTitleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CurrJobTitleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CurrJobTitleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		currJobTitleService = (CurrJobTitleService)aopProxy;

		_setServiceUtilService(currJobTitleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CurrJobTitleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		CurrJobTitleService currJobTitleService) {

		try {
			Field field = CurrJobTitleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, currJobTitleService);
		}
	...
	@Reference
	protected com.prime.data.service.service.CurrJobTitleLocalService
		currJobTitleLocalService;

	protected CurrJobTitleService currJobTitleService;
