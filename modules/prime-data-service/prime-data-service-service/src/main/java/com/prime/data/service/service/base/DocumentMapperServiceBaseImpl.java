...
import com.prime.data.service.service.DocumentMapperService;
import com.prime.data.service.service.DocumentMapperServiceUtil;
...
/**
 * Provides the base implementation for the document mapper remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.DocumentMapperServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.DocumentMapperServiceImpl
 * @generated
 */
public abstract class DocumentMapperServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocumentMapperService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentMapperService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DocumentMapperServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentMapperService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		documentMapperService = (DocumentMapperService)aopProxy;

		_setServiceUtilService(documentMapperService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentMapperService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DocumentMapperServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, documentMapperService);
		}
	...
	@Reference
	protected com.prime.data.service.service.DocumentMapperLocalService
		documentMapperLocalService;

	protected DocumentMapperService documentMapperService;
