...
import com.prime.data.service.service.CandidateStatusService;
import com.prime.data.service.service.CandidateStatusServiceUtil;
...
/**
 * Provides the base implementation for the candidate status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.CandidateStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.CandidateStatusServiceImpl
 * @generated
 */
public abstract class CandidateStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CandidateStatusService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CandidateStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CandidateStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CandidateStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		candidateStatusService = (CandidateStatusService)aopProxy;

		_setServiceUtilService(candidateStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CandidateStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = CandidateStatusServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, candidateStatusService);
		}
	...
	@Reference
	protected com.prime.data.service.service.CandidateStatusLocalService
		candidateStatusLocalService;

	protected CandidateStatusService candidateStatusService;
