...
import com.prime.data.service.service.NamePrefixService;
import com.prime.data.service.service.NamePrefixServiceUtil;
...
/**
 * Provides the base implementation for the name prefix remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.NamePrefixServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.NamePrefixServiceImpl
 * @generated
 */
public abstract class NamePrefixServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NamePrefixService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NamePrefixService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NamePrefixServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NamePrefixService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		namePrefixService = (NamePrefixService)aopProxy;

		_setServiceUtilService(namePrefixService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NamePrefixService.class.getName();
	}
	...
	private void _setServiceUtilService(NamePrefixService namePrefixService) {
		try {
			Field field = NamePrefixServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, namePrefixService);
		}
	...
	@Reference
	protected com.prime.data.service.service.NamePrefixLocalService
		namePrefixLocalService;

	protected NamePrefixService namePrefixService;
