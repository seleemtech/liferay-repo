...
import com.prime.data.service.service.MainTableService;
import com.prime.data.service.service.MainTableServiceUtil;
...
/**
 * Provides the base implementation for the main table remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.MainTableServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.MainTableServiceImpl
 * @generated
 */
public abstract class MainTableServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MainTableService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MainTableService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MainTableServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MainTableService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		mainTableService = (MainTableService)aopProxy;

		_setServiceUtilService(mainTableService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MainTableService.class.getName();
	}
	...
	private void _setServiceUtilService(MainTableService mainTableService) {
		try {
			Field field = MainTableServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, mainTableService);
		}
	...
	@Reference
	protected com.prime.data.service.service.MainTableLocalService
		mainTableLocalService;

	protected MainTableService mainTableService;
