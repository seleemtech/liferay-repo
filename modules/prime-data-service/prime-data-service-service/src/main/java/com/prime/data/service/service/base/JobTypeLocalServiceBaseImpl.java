...
import com.prime.data.service.service.JobTypeLocalService;
...
/**
 * Provides the base implementation for the job type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.JobTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.JobTypeLocalServiceImpl
 * @generated
 */
public abstract class JobTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, JobTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JobTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JobTypeLocalServiceUtil</code>.
	 */
	...
	public JobType addJobType(JobType jobType) {
		...
		return jobTypePersistence.update(jobType);
	}
	...
	public JobType createJobType(long jobTypeId) {
		return jobTypePersistence.create(jobTypeId);
	}
	...
	public JobType deleteJobType(long jobTypeId) throws PortalException {
		return jobTypePersistence.remove(jobTypeId);
	}
	...
	public JobType deleteJobType(JobType jobType) {
		return jobTypePersistence.remove(jobType);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return jobTypePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JobType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jobTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return jobTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jobTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return jobTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public JobType fetchJobType(long jobTypeId) {
		return jobTypePersistence.fetchByPrimaryKey(jobTypeId);
	}
	...
	public JobType getJobType(long jobTypeId) throws PortalException {
		return jobTypePersistence.findByPrimaryKey(jobTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(jobTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JobType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("jobTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(JobType.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("jobTypeId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return jobTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return jobTypeLocalService.deleteJobType((JobType)persistedModel);
	}

	@Override
	public BasePersistence<JobType> getBasePersistence() {
		return jobTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return jobTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<JobType> getJobTypes(int start, int end) {
		return jobTypePersistence.findAll(start, end);
	}
	...
	public int getJobTypesCount() {
		return jobTypePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JobTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		jobTypeLocalService = (JobTypeLocalService)aopProxy;

		_setLocalServiceUtilService(jobTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobTypeLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		JobTypeLocalService jobTypeLocalService) {

		try {
			Field field = JobTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jobTypeLocalService);
		}
	...
	protected JobTypeLocalService jobTypeLocalService;
