...
import com.prime.data.service.service.SourceByService;
import com.prime.data.service.service.SourceByServiceUtil;
...
/**
 * Provides the base implementation for the source by remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.SourceByServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.SourceByServiceImpl
 * @generated
 */
public abstract class SourceByServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SourceByService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SourceByService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SourceByServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SourceByService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sourceByService = (SourceByService)aopProxy;

		_setServiceUtilService(sourceByService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SourceByService.class.getName();
	}
	...
	private void _setServiceUtilService(SourceByService sourceByService) {
		try {
			Field field = SourceByServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, sourceByService);
		}
	...
	@Reference
	protected com.prime.data.service.service.SourceByLocalService
		sourceByLocalService;

	protected SourceByService sourceByService;
