...
import com.prime.data.service.service.ProjectStatusService;
import com.prime.data.service.service.ProjectStatusServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.ProjectStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.ProjectStatusServiceImpl
 * @generated
 */
public abstract class ProjectStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProjectStatusService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProjectStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProjectStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProjectStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		projectStatusService = (ProjectStatusService)aopProxy;

		_setServiceUtilService(projectStatusService);
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProjectStatusServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, projectStatusService);
		}
	...
	@Reference
	protected com.prime.data.service.service.ProjectStatusLocalService
