...
import com.prime.data.service.service.JobOpeningStatusService;
import com.prime.data.service.service.JobOpeningStatusServiceUtil;
...
/**
 * Provides the base implementation for the job opening status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.prime.data.service.service.impl.JobOpeningStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.prime.data.service.service.impl.JobOpeningStatusServiceImpl
 * @generated
 */
public abstract class JobOpeningStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JobOpeningStatusService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JobOpeningStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JobOpeningStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JobOpeningStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jobOpeningStatusService = (JobOpeningStatusService)aopProxy;

		_setServiceUtilService(jobOpeningStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobOpeningStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = JobOpeningStatusServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jobOpeningStatusService);
		}
	...
	@Reference
	protected com.prime.data.service.service.JobOpeningStatusLocalService
		jobOpeningStatusLocalService;

	protected JobOpeningStatusService jobOpeningStatusService;
