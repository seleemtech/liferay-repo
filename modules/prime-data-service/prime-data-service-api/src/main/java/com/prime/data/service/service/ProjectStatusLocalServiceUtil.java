 ...
 * <code>com.prime.data.service.service.impl.ProjectStatusLocalServiceImpl</code> and
...
public class ProjectStatusLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.ProjectStatusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProjectStatus addProjectStatus(ProjectStatus projectStatus) {
		return getService().addProjectStatus(projectStatus);
	}

	public static void addProjectStatus(String projectStatusName) {
		getService().addProjectStatus(projectStatusName);
	}
	 ...
	 */
	public static ProjectStatus createProjectStatus(long projectStatusId) {
	 ...
	 */
	public static ProjectStatus deleteProjectStatus(long projectStatusId)
		throws PortalException {
	 ...
	 * @return the project status that was removed
	 */
	public static ProjectStatus deleteProjectStatus(
	...
	public static ProjectStatus fetchProjectStatus(long projectStatusId) {
	 ...
	 * @throws PortalException if a project status with the primary key could not be found
	 */
	public static ProjectStatus getProjectStatus(long projectStatusId)
		throws PortalException {
	 ...
	 */
	public static List<ProjectStatus> getProjectStatuses(int start, int end) {
	 ...
	 */
	public static ProjectStatus updateProjectStatus(
		ProjectStatus projectStatus) {
	...
	private static volatile ProjectStatusLocalService _service;
