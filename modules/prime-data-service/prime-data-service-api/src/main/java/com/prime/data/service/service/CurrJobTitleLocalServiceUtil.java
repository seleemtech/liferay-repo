...
/**
 * Provides the local service utility for CurrJobTitle. This utility wraps
 * <code>com.prime.data.service.service.impl.CurrJobTitleLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CurrJobTitleLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.CurrJobTitleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CurrJobTitle addCurrJobTitle(CurrJobTitle currJobTitle) {
		return getService().addCurrJobTitle(currJobTitle);
	}

	public static void addCurrJobTitle(String currentJobTitle) {
		getService().addCurrJobTitle(currentJobTitle);
	}
	 ...
	 */
	public static CurrJobTitle createCurrJobTitle(long currJobTitleId) {
		return getService().createCurrJobTitle(currJobTitleId);
	}
	 ...
	 */
	public static CurrJobTitle deleteCurrJobTitle(CurrJobTitle currJobTitle) {
		return getService().deleteCurrJobTitle(currJobTitle);
	}
	 ...
	 */
	public static CurrJobTitle deleteCurrJobTitle(long currJobTitleId)
		throws PortalException {

		return getService().deleteCurrJobTitle(currJobTitleId);
	}
	...
	public static CurrJobTitle fetchCurrJobTitle(long currJobTitleId) {
		return getService().fetchCurrJobTitle(currJobTitleId);
	}
	 ...
	 * @throws PortalException if a curr job title with the primary key could not be found
	 */
	public static CurrJobTitle getCurrJobTitle(long currJobTitleId)
		throws PortalException {

		return getService().getCurrJobTitle(currJobTitleId);
	}
	 ...
	 */
	public static List<CurrJobTitle> getCurrJobTitles(int start, int end) {
		return getService().getCurrJobTitles(start, end);
	}
	 ...
	 */
	public static int getCurrJobTitlesCount() {
		return getService().getCurrJobTitlesCount();
	}
	 ...
	 */
	public static CurrJobTitle updateCurrJobTitle(CurrJobTitle currJobTitle) {
		return getService().updateCurrJobTitle(currJobTitle);
	}

	public static CurrJobTitleLocalService getService() {
		return _service;
	}

	private static volatile CurrJobTitleLocalService _service;
