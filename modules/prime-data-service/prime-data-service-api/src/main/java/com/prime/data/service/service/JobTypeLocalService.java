...
/**
 * Provides the local service interface for JobType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JobTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JobTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.prime.data.service.service.impl.JobTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the job type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JobTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public JobType createJobType(long jobTypeId);
	...
	public JobType deleteJobType(JobType jobType);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public JobType deleteJobType(long jobTypeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobType fetchJobType(long jobTypeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobType getJobType(long jobTypeId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JobType> getJobTypes(int start, int end);
