...
/**
 * Provides the local service utility for NamePrefix. This utility wraps
 * <code>com.prime.data.service.service.impl.NamePrefixLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NamePrefixLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.NamePrefixLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NamePrefix addNamePrefix(NamePrefix namePrefix) {
		return getService().addNamePrefix(namePrefix);
	}

	public static void addNamePrefix(String namePrefix) {
		getService().addNamePrefix(namePrefix);
	}
	 ...
	 */
	public static NamePrefix createNamePrefix(long namePrefixId) {
		return getService().createNamePrefix(namePrefixId);
	}
	 ...
	 */
	public static NamePrefix deleteNamePrefix(long namePrefixId)
		throws PortalException {

		return getService().deleteNamePrefix(namePrefixId);
	}
	 ...
	 * @return the name prefix that was removed
	 */
	public static NamePrefix deleteNamePrefix(NamePrefix namePrefix) {
		return getService().deleteNamePrefix(namePrefix);
	}
	...
	public static NamePrefix fetchNamePrefix(long namePrefixId) {
		return getService().fetchNamePrefix(namePrefixId);
	}
	 ...
	 * @throws PortalException if a name prefix with the primary key could not be found
	 */
	public static NamePrefix getNamePrefix(long namePrefixId)
		throws PortalException {

		return getService().getNamePrefix(namePrefixId);
	}
	 ...
	 */
	public static List<NamePrefix> getNamePrefixes(int start, int end) {
		return getService().getNamePrefixes(start, end);
	}
	 ...
	 */
	public static int getNamePrefixesCount() {
		return getService().getNamePrefixesCount();
	}
	 ...
	 */
	public static NamePrefix updateNamePrefix(NamePrefix namePrefix) {
		return getService().updateNamePrefix(namePrefix);
	}

	public static NamePrefixLocalService getService() {
		return _service;
	}

	private static volatile NamePrefixLocalService _service;
