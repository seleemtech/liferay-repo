...
/**
 * Provides the local service utility for WorkType. This utility wraps
 * <code>com.prime.data.service.service.impl.WorkTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class WorkTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.WorkTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addWorkType(String workTypeName) {
		getService().addWorkType(workTypeName);
	}
	 ...
	 */
	public static WorkType addWorkType(WorkType workType) {
		return getService().addWorkType(workType);
	}
	 ...
	 */
	public static WorkType createWorkType(long workTypeId) {
		return getService().createWorkType(workTypeId);
	}
	 ...
	 */
	public static WorkType deleteWorkType(long workTypeId)
		throws PortalException {

		return getService().deleteWorkType(workTypeId);
	}
	 ...
	 * @return the work type that was removed
	 */
	public static WorkType deleteWorkType(WorkType workType) {
		return getService().deleteWorkType(workType);
	}
	...
	public static WorkType fetchWorkType(long workTypeId) {
		return getService().fetchWorkType(workTypeId);
	}
	 ...
	 * @throws PortalException if a work type with the primary key could not be found
	 */
	public static WorkType getWorkType(long workTypeId) throws PortalException {
		return getService().getWorkType(workTypeId);
	}
	 ...
	 */
	public static List<WorkType> getWorkTypes(int start, int end) {
		return getService().getWorkTypes(start, end);
	}
	 ...
	 */
	public static int getWorkTypesCount() {
		return getService().getWorkTypesCount();
	}
	 ...
	 */
	public static WorkType updateWorkType(WorkType workType) {
		return getService().updateWorkType(workType);
	}

	public static WorkTypeLocalService getService() {
		return _service;
	}

	private static volatile WorkTypeLocalService _service;
