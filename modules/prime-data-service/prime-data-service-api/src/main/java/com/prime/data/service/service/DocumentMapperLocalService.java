...
/**
 * Provides the local service interface for DocumentMapper. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentMapperLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocumentMapperLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.prime.data.service.service.impl.DocumentMapperLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the document mapper local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentMapperLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DocumentMapper AddOrUpdateDocument(
		long recordId, String moduleName, long classPk, String documentName,
		long documentId, Date createdDate, Date modifiedDate,
