...
/**
 * Provides the local service utility for SalesStage. This utility wraps
 * <code>com.prime.data.service.service.impl.SalesStageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SalesStageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.SalesStageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SalesStage addSalesStage(SalesStage salesStage) {
		return getService().addSalesStage(salesStage);
	}

	public static void addSalesStage(String saleStage) {
		getService().addSalesStage(saleStage);
	}
	 ...
	 */
	public static SalesStage createSalesStage(long salesStageId) {
		return getService().createSalesStage(salesStageId);
	}
	 ...
	 */
	public static SalesStage deleteSalesStage(long salesStageId)
		throws PortalException {

		return getService().deleteSalesStage(salesStageId);
	}
	 ...
	 * @return the sales stage that was removed
	 */
	public static SalesStage deleteSalesStage(SalesStage salesStage) {
		return getService().deleteSalesStage(salesStage);
	}
	...
	public static SalesStage fetchSalesStage(long salesStageId) {
		return getService().fetchSalesStage(salesStageId);
	}
	 ...
	 * @throws PortalException if a sales stage with the primary key could not be found
	 */
	public static SalesStage getSalesStage(long salesStageId)
		throws PortalException {

		return getService().getSalesStage(salesStageId);
	}
	 ...
	 */
	public static List<SalesStage> getSalesStages(int start, int end) {
		return getService().getSalesStages(start, end);
	}
	 ...
	 */
	public static int getSalesStagesCount() {
		return getService().getSalesStagesCount();
	}
	 ...
	 */
	public static SalesStage updateSalesStage(SalesStage salesStage) {
		return getService().updateSalesStage(salesStage);
	}

	public static SalesStageLocalService getService() {
		return _service;
	}

	private static volatile SalesStageLocalService _service;
