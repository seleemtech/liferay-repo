...
/**
 * The persistence utility for the work experience service. This utility wraps <code>com.prime.data.service.service.persistence.impl.WorkExperiencePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WorkExperienceUtil {
	 ...
	 */
	public static Map<Serializable, WorkExperience> fetchByPrimaryKeys(
	 ...
	 */
	public static WorkExperience update(
		WorkExperience workExperience, ServiceContext serviceContext) {
	 ...
	 */
	public static List<WorkExperience> findByUuid(String uuid) {
	 ...
	 */
	public static List<WorkExperience> findByUuid(
	 ...
	 */
	public static WorkExperience findByUuid_First(
			String uuid, OrderByComparator<WorkExperience> orderByComparator)
		throws com.prime.data.service.exception.NoSuchWorkExperienceException {
	 ...
	 */
	public static WorkExperience fetchByUuid_First(
		String uuid, OrderByComparator<WorkExperience> orderByComparator) {
	 ...
	 * @throws NoSuchWorkExperienceException if a matching work experience could not be found
	 */
	public static WorkExperience findByUuid_Last(
			String uuid, OrderByComparator<WorkExperience> orderByComparator)
		throws com.prime.data.service.exception.NoSuchWorkExperienceException {
	 ...
	 */
	public static WorkExperience fetchByUuid_Last(
		String uuid, OrderByComparator<WorkExperience> orderByComparator) {
	 ...
	 */
	public static WorkExperience[] findByUuid_PrevAndNext(
			long workExpId, String uuid,
			OrderByComparator<WorkExperience> orderByComparator)
		throws com.prime.data.service.exception.NoSuchWorkExperienceException {

		return getPersistence().findByUuid_PrevAndNext(
			workExpId, uuid, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(WorkExperience workExperience) {
	 ...
	 */
	public static void cacheResult(List<WorkExperience> workExperiences) {
	 ...
	 */
	public static WorkExperience create(long workExpId) {
		return getPersistence().create(workExpId);
	}
	 ...
	 * @throws NoSuchWorkExperienceException if a work experience with the primary key could not be found
	 */
	public static WorkExperience remove(long workExpId)
		throws com.prime.data.service.exception.NoSuchWorkExperienceException {

		return getPersistence().remove(workExpId);
	}

	public static WorkExperience updateImpl(WorkExperience workExperience) {
	 ...
	 * @throws NoSuchWorkExperienceException if a work experience with the primary key could not be found
	 */
	public static WorkExperience findByPrimaryKey(long workExpId)
		throws com.prime.data.service.exception.NoSuchWorkExperienceException {

		return getPersistence().findByPrimaryKey(workExpId);
	}
	 ...
	 */
	public static WorkExperience fetchByPrimaryKey(long workExpId) {
		return getPersistence().fetchByPrimaryKey(workExpId);
	}
	 ...
	 */
	public static List<WorkExperience> findAll() {
	 ...
	 */
	public static List<WorkExperience> findAll(int start, int end) {
	...
	private static volatile WorkExperiencePersistence _persistence;
