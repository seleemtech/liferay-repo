...
/**
 * Provides the local service utility for DocumentMapper. This utility wraps
 * <code>com.prime.data.service.service.impl.DocumentMapperLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DocumentMapperLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.prime.data.service.service.impl.DocumentMapperLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DocumentMapper addDocumentMapper(
		DocumentMapper documentMapper) {

		return getService().addDocumentMapper(documentMapper);
	}

	public static DocumentMapper AddOrUpdateDocument(
	 ...
	 */
	public static DocumentMapper createDocumentMapper(long recordId) {
		return getService().createDocumentMapper(recordId);
	}
	 ...
	 */
	public static DocumentMapper deleteDocumentMapper(
		DocumentMapper documentMapper) {

		return getService().deleteDocumentMapper(documentMapper);
	}
	 ...
	 */
	public static DocumentMapper deleteDocumentMapper(long recordId)
		throws PortalException {

		return getService().deleteDocumentMapper(recordId);
	}
	...
	public static DocumentMapper fetchDocumentMapper(long recordId) {
		return getService().fetchDocumentMapper(recordId);
	}
	 ...
	 * @throws PortalException if a document mapper with the primary key could not be found
	 */
	public static DocumentMapper getDocumentMapper(long recordId)
		throws PortalException {

		return getService().getDocumentMapper(recordId);
	}
	 ...
	 */
	public static List<DocumentMapper> getDocumentMappers(int start, int end) {
		return getService().getDocumentMappers(start, end);
	}
	 ...
	 */
	public static int getDocumentMappersCount() {
		return getService().getDocumentMappersCount();
	}
	 ...
	 */
	public static DocumentMapper updateDocumentMapper(
		DocumentMapper documentMapper) {

		return getService().updateDocumentMapper(documentMapper);
	}

	public static DocumentMapperLocalService getService() {
		return _service;
	}

	private static volatile DocumentMapperLocalService _service;
