...
public class SkillSetUtil {
	...
	public static SkillSet findByUuid_First(
		...
		throws com.prime.data.service.exception.NoSuchSkillSetException {
	...
	private static volatile SkillSetPersistence _persistence;
