        ...
        <aui:button-row>
            <portlet:renderURL var="nextStepURL">
                <portlet:param name="mvcRenderCommandName"
                               value="secondConnectionName"/>
            </portlet:renderURL>
            <aui:button cssClass="pull-right" name="firstAppContinue" id="firstAppContinue"
...
<script>
    Liferay.provide(
        ...
        () => {
            ...
            sessionStorage.setItem('firstAppRefreshToken', refreshTokenInput.val());
            sessionStorage.setItem('firstAppUserEmailAddress', emailAddressInput.val());

            sessionStorage.setItem('firstAppSpreadSheetId', spreadsheetValueInput.val());
            sessionStorage.setItem('firstAppWorkSheetName', workSheetInput.val());
            ...
            portletURL.setParameter('mvcRenderCommandName', 'secondConnectionName');
