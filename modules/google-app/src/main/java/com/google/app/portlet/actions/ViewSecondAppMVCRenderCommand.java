...
@Component(
        property = {
                ...
                "mvc.command.name=secondConnectionName"
        },
        service = MVCRenderCommand.class
)
public class ViewSecondAppMVCRenderCommand implements MVCRenderCommand {

    @Override
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) {

        renderRequest.setAttribute("pageName","secondConnection");
        return "/step/second-app-credentials.jsp";
    }
