...
import com.exportdb.service.exception.NoSuchStudentException;
...
public interface StudentPersistence extends BasePersistence<Student> {
	 ...
	 */
	public Student create(long sid);
	 ...
	 */
	public Student remove(long sid) throws NoSuchStudentException;
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public Student findByPrimaryKey(long sid) throws NoSuchStudentException;
	 ...
	 */
	public Student fetchByPrimaryKey(long sid);
