...
import com.exportdb.service.model.StudentModel;
...
public class StudentModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"sid", Types.BIGINT}, {"sname", Types.VARCHAR}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("sname", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE =
		"create table student (sid LONG not null primary key,sname VARCHAR(75) null)";
	...
	public static final String DATA_SOURCE = "ext";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.exportdb.service.service.util.ServiceProps.get(
			"lock.expiration.time.com.exportdb.service.model.Student"));
	...
	static {
		...
		attributeGetterFunctions.put("sid", Student::getSid);
		attributeSetterBiConsumers.put(
			"sid", (BiConsumer<Student, Long>)Student::setSid);
		attributeGetterFunctions.put("sname", Student::getSname);
		attributeSetterBiConsumers.put(
			"sname", (BiConsumer<Student, String>)Student::setSname);
	...
	public Student cloneWithOriginalValues() {
		...
		studentImpl.setSid(this.<Long>getColumnOriginalValue("sid"));
		studentImpl.setSname(this.<String>getColumnOriginalValue("sname"));
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("sname", _sname);
	}
