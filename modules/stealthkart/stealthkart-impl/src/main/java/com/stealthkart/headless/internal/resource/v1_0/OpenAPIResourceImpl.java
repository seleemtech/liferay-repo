...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Stealthkart REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Stealthkart", version = "v1.0")
)
@Path("/v1.0")
