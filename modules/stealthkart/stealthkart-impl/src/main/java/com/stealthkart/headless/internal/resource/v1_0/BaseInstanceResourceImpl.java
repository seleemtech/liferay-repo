...
public abstract class BaseInstanceResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/stealthkart/v1.0/{companyId}/instaces'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/{companyId}/instaces")
	@javax.ws.rs.Produces({"appliction/json", "appliction/xml"})
	@Override
	public Page<Instance> getInstancePage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/stealthkart/v1.0/{companyId}/instaces/update' -d $'{"companyId": ___, "emailAddress": ___, "instanceName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/{companyId}/instaces/update")
	@javax.ws.rs.Produces({"appliction/json", "appliction/xml"})
	@javax.ws.rs.PUT
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/stealthkart/v1.0/instaces/Add' -d $'{"companyId": ___, "emailAddress": ___, "instanceName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Instance")}
	)
	@javax.ws.rs.Consumes({"appliction/json", "appliction/xml"})
	@javax.ws.rs.Path("/instaces/Add")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"appliction/json", "appliction/xml"})
	@Override
