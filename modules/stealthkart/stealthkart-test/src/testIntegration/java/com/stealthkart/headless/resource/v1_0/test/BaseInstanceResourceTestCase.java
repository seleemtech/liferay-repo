package com.stealthkart.headless.resource.v1_0.test;
...
import com.stealthkart.headless.client.http.HttpInvoker;
import com.stealthkart.headless.client.pagination.Page;
import com.stealthkart.headless.client.resource.v1_0.InstanceResource;
...
public abstract class BaseInstanceResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		instance.setEmailAddress(regex);
		instance.setInstanceName(regex);
		...
		Assert.assertEquals(regex, instance.getEmailAddress());
		Assert.assertEquals(regex, instance.getInstanceName());
	}

	@Test
	public void testGetInstancePage() throws Exception {
		Long companyId = testGetInstancePage_getCompanyId();
		Long irrelevantCompanyId = testGetInstancePage_getIrrelevantCompanyId();

		Page<Instance> page = instanceResource.getInstancePage(companyId);

		Assert.assertEquals(0, page.getTotalCount());

		if (irrelevantCompanyId != null) {
			Instance irrelevantInstance = testGetInstancePage_addInstance(
				irrelevantCompanyId, randomIrrelevantInstance());

			page = instanceResource.getInstancePage(irrelevantCompanyId);
		...
		Instance instance1 = testGetInstancePage_addInstance(
			companyId, randomInstance());

		Instance instance2 = testGetInstancePage_addInstance(
			companyId, randomInstance());

		page = instanceResource.getInstancePage(companyId);
	...
	protected Instance testGetInstancePage_addInstance(
	...
	protected Long testGetInstancePage_getCompanyId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetInstancePage_getIrrelevantCompanyId()
		throws Exception {
	...
	@Test
	public void testUpdateInstancePage() throws Exception {
		Assert.assertTrue(false);
	}

	@Test
	public void testPostInstaceAdd() throws Exception {
		Instance randomInstance = randomInstance();

		Instance postInstance = testPostInstaceAdd_addInstance(randomInstance);

		assertEquals(randomInstance, postInstance);
		assertValid(postInstance);
	}

	protected Instance testPostInstaceAdd_addInstance(Instance instance)
		throws Exception {
	...
	protected void assertValid(Instance instance) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("instanceName", additionalAssertFieldName)) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.stealthkart.headless.dto.v1_0.Instance.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("companyId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						instance1.getCompanyId(), instance2.getCompanyId())) {
			...
			if (Objects.equals("emailAddress", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						instance1.getEmailAddress(),
						instance2.getEmailAddress())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("emailAddress")) {
			sb.append("'");
			sb.append(String.valueOf(instance.getEmailAddress()));
			sb.append("'");

			return sb.toString();
		}

		if (entityFieldName.equals("instanceName")) {
			sb.append("'");
			sb.append(String.valueOf(instance.getInstanceName()));
			sb.append("'");
		...
		return new Instance() {
			{
				...
				emailAddress =
					StringUtil.toLowerCase(RandomTestUtil.randomString()) +
						"@liferay.com";
				instanceName = StringUtil.toLowerCase(
	...
	@Inject
	private com.stealthkart.headless.resource.v1_0.InstanceResource
		_instanceResource;
