package CrudRestBuild.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	@GraphQLName(
		description = "null", value = "putCrudCrudUpdatePageCrudIdCrudRest"
	)
	public java.util.Collection<CrudRest> updateCrudCrudUpdatePage(
		...
		return _applyComponentServiceObjects(
			...
			crudRestResource -> {
				Page paginationPage = crudRestResource.putCrudCrudUpdatePage(
					crudId, crudRest);
	...
	@GraphQLField
	@GraphQLName(description = "null", value = "postCrudAddPageCrudRest")
	public java.util.Collection<CrudRest> createCrudAddPage(
			@GraphQLName("crudRest") CrudRest crudRest)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			crudRestResource -> {
				Page paginationPage = crudRestResource.postCrudAddPage(
					crudRest);
