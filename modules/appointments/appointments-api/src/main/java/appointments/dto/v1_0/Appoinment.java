 ...
 */
@Generated("")
@GraphQLName(description = "Represents appointment.", value = "Appoinment")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Appoinment")
public class Appoinment implements Serializable {

	public static Appoinment toDTO(String json) {
		return ObjectMapperUtil.readValue(Appoinment.class, json);
	}

	public static Appoinment unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Appoinment.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "appointments.dto.v1_0.Appoinment", name = "x-class-name"
	)
