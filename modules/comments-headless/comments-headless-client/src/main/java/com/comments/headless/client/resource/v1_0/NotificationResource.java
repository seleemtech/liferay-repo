...
public interface NotificationResource {
	...
	public HttpInvoker.HttpResponse getUserNotificationHttpResponse(Long userId)
		throws Exception;
	...
	public static class NotificationResourceImpl
		...
		public Page<Notification> getUserNotification(Long userId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getUserNotificationHttpResponse(userId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/comments-headless/v1.0/get-user-notifications/{userId}");
