 ...
 */
@Generated("")
@GraphQLName("CustomObjectDefinition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CustomObjectDefinition")
public class CustomObjectDefinition implements Serializable {

	public static CustomObjectDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(CustomObjectDefinition.class, json);
	}

	public static CustomObjectDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			CustomObjectDefinition.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.comments.headless.dto.v1_0.CustomObjectDefinition",
		name = "x-class-name"
	)
