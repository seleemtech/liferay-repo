...
import com.comments.headless.client.resource.v1_0.NotificationResource;
...
public abstract class BaseNotificationResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		notification.setNotificationMessage(regex);
		notification.setNotificationTimeDiff(regex);
		...
		Assert.assertEquals(regex, notification.getNotificationMessage());
		Assert.assertEquals(regex, notification.getNotificationTimeDiff());
	}

	@Test
	public void testGetUserNotification() throws Exception {
		Long userId = testGetUserNotification_getUserId();
		Long irrelevantUserId = testGetUserNotification_getIrrelevantUserId();

		Page<Notification> page = notificationResource.getUserNotification(
			userId);

		Assert.assertEquals(0, page.getTotalCount());

		if (irrelevantUserId != null) {
			Notification irrelevantNotification =
				testGetUserNotification_addNotification(
					irrelevantUserId, randomIrrelevantNotification());

			page = notificationResource.getUserNotification(irrelevantUserId);

			Assert.assertEquals(1, page.getTotalCount());

			assertEquals(
				Arrays.asList(irrelevantNotification),
				(List<Notification>)page.getItems());
			assertValid(
				page,
				testGetUserNotification_getExpectedActions(irrelevantUserId));
		}

		Notification notification1 = testGetUserNotification_addNotification(
			userId, randomNotification());

		Notification notification2 = testGetUserNotification_addNotification(
			userId, randomNotification());

		page = notificationResource.getUserNotification(userId);
		...
		assertEqualsIgnoringOrder(
			...
			(List<Notification>)page.getItems());
		assertValid(page, testGetUserNotification_getExpectedActions(userId));
	}

	protected Map<String, Map<String, String>>
			testGetUserNotification_getExpectedActions(Long userId)
		throws Exception {
	...
	protected Notification testGetUserNotification_addNotification(
	...
	protected Long testGetUserNotification_getUserId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetUserNotification_getIrrelevantUserId()
		throws Exception {
	...
	protected void assertValid(Notification notification) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"notificationEventId", additionalAssertFieldName)) {
			...
			if (Objects.equals(
					"notificationTimeDiff", additionalAssertFieldName)) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.comments.headless.dto.v1_0.Notification.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						notification1.getNotificationEventId(),
						notification2.getNotificationEventId())) {
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						notification1.getNotificationMessage(),
						notification2.getNotificationMessage())) {
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						notification1.getNotificationTimeDiff(),
						notification2.getNotificationTimeDiff())) {
			...
			if (Objects.equals("userId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						notification1.getUserId(), notification2.getUserId())) {
			...
			if (Objects.equals("workflowTaskId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						notification1.getWorkflowTaskId(),
						notification2.getWorkflowTaskId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("notificationEventId")) {
			throw new IllegalArgumentException(
		...
		if (entityFieldName.equals("notificationMessage")) {
			sb.append("'");
			sb.append(String.valueOf(notification.getNotificationMessage()));
			sb.append("'");

			return sb.toString();
		}

		if (entityFieldName.equals("notificationTimeDiff")) {
			sb.append("'");
			sb.append(String.valueOf(notification.getNotificationTimeDiff()));
			sb.append("'");
	...
	protected Notification randomNotification() throws Exception {
		return new Notification() {
			{
				notificationEventId = RandomTestUtil.randomLong();
				notificationMessage = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				notificationTimeDiff = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
	...
	@Inject
	private com.comments.headless.resource.v1_0.NotificationResource
