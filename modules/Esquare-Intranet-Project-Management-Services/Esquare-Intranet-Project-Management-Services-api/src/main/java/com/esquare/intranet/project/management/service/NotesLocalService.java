...
public interface NotesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.NotesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notes local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Notes createNotes(long noteId);
	...
	public Notes deleteNotes(long noteId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Notes fetchNotes(long noteId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Notes getNotes(long noteId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Notes> getNoteses(int start, int end);
