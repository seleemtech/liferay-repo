...
/**
 * Provides the local service interface for TeamMembers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mahammed Seleem
 * @see TeamMembersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TeamMembersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.TeamMembersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the team members local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TeamMembersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TeamMembers addTeamMenber(
