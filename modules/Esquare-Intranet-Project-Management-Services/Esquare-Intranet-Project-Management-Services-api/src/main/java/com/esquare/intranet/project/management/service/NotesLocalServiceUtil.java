 ...
 * <code>com.esquare.intranet.project.management.service.impl.NotesLocalServiceImpl</code> and
...
public class NotesLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.NotesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Notes addNotes(Notes notes) {
	 ...
	 */
	public static Notes createNotes(long noteId) {
		return getService().createNotes(noteId);
	}
	 ...
	 */
	public static Notes deleteNotes(long noteId) throws PortalException {
		return getService().deleteNotes(noteId);
	}
	...
	public static Notes fetchNotes(long noteId) {
		return getService().fetchNotes(noteId);
	}
	 ...
	 * @throws PortalException if a notes with the primary key could not be found
	 */
	public static Notes getNotes(long noteId) throws PortalException {
		return getService().getNotes(noteId);
	}
	 ...
	 */
	public static List<Notes> getNoteses(int start, int end) {
	 ...
	 */
	public static Notes updateNotes(Notes notes) {
	...
	private static volatile NotesLocalService _service;
