...
/**
 * Provides the local service interface for ProjectManagement. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mahammed Seleem
 * @see ProjectManagementLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProjectManagementLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.ProjectManagementLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the project management local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProjectManagementLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProjectManagement addProjectManagement(
	...
	public ProjectManagement createProjectManagement(long projectMgmtId);
	...
	public ProjectManagement deleteProjectManagement(long projectMgmtId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProjectManagement deleteProjectManagement(
		ProjectManagement projectManagement);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectManagement fetchProjectManagement(long projectMgmtId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectManagement fetchProjectManagementByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectManagement getProjectManagement(long projectMgmtId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectManagement getProjectManagementByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectManagement> getProjectManagements(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectManagement> getProjectManagementsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProjectManagement updateProjectManagement(
		ProjectManagement projectManagement);
