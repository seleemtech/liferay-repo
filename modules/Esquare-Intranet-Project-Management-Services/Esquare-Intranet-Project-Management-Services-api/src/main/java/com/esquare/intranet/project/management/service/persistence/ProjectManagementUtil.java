...
/**
 * The persistence utility for the project management service. This utility wraps <code>com.esquare.intranet.project.management.service.persistence.impl.ProjectManagementPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ProjectManagementPersistence
 * @generated
 */
public class ProjectManagementUtil {
	 ...
	 */
	public static void clearCache(ProjectManagement projectManagement) {
		getPersistence().clearCache(projectManagement);
	}
	 ...
	 */
	public static Map<Serializable, ProjectManagement> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ProjectManagement> findWithDynamicQuery(
	 ...
	 */
	public static ProjectManagement update(
		ProjectManagement projectManagement) {

		return getPersistence().update(projectManagement);
	}
	 ...
	 */
	public static ProjectManagement update(
		ProjectManagement projectManagement, ServiceContext serviceContext) {

		return getPersistence().update(projectManagement, serviceContext);
	}
	 ...
	 */
	public static List<ProjectManagement> findByUuid(String uuid) {
	 ...
	 */
	public static List<ProjectManagement> findByUuid(
	 ...
	 */
	public static ProjectManagement findByUuid_First(
		...
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 */
	public static ProjectManagement fetchByUuid_First(
		String uuid, OrderByComparator<ProjectManagement> orderByComparator) {
	 ...
	 * @throws NoSuchProjectManagementException if a matching project management could not be found
	 */
	public static ProjectManagement findByUuid_Last(
			String uuid, OrderByComparator<ProjectManagement> orderByComparator)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 */
	public static ProjectManagement fetchByUuid_Last(
		String uuid, OrderByComparator<ProjectManagement> orderByComparator) {
	 ...
	 */
	public static ProjectManagement[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			projectMgmtId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchProjectManagementException if a matching project management could not be found
	 */
	public static ProjectManagement findByUUID_G(String uuid, long groupId)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 */
	public static ProjectManagement fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching project management, or <code>null</code> if a matching project management could not be found
	 */
	public static ProjectManagement fetchByUUID_G(
	 ...
	 */
	public static ProjectManagement removeByUUID_G(String uuid, long groupId)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 * @return the matching project managements
	 */
	public static List<ProjectManagement> findByUuid_C(
	 ...
	 * @throws NoSuchProjectManagementException if a matching project management could not be found
	 */
	public static ProjectManagement findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<ProjectManagement> orderByComparator)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 * @return the first matching project management, or <code>null</code> if a matching project management could not be found
	 */
	public static ProjectManagement fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<ProjectManagement> orderByComparator) {
	 ...
	 * @throws NoSuchProjectManagementException if a matching project management could not be found
	 */
	public static ProjectManagement findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<ProjectManagement> orderByComparator)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {
	 ...
	 * @return the last matching project management, or <code>null</code> if a matching project management could not be found
	 */
	public static ProjectManagement fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<ProjectManagement> orderByComparator) {
	 ...
	 * @throws NoSuchProjectManagementException if a project management with the primary key could not be found
	 */
	public static ProjectManagement[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			projectMgmtId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(ProjectManagement projectManagement) {
		getPersistence().cacheResult(projectManagement);
	}
	 ...
	 */
	public static void cacheResult(List<ProjectManagement> projectManagements) {
		getPersistence().cacheResult(projectManagements);
	}
	 ...
	 */
	public static ProjectManagement create(long projectMgmtId) {
		return getPersistence().create(projectMgmtId);
	}
	 ...
	 * @throws NoSuchProjectManagementException if a project management with the primary key could not be found
	 */
	public static ProjectManagement remove(long projectMgmtId)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {

		return getPersistence().remove(projectMgmtId);
	}

	public static ProjectManagement updateImpl(
		ProjectManagement projectManagement) {

		return getPersistence().updateImpl(projectManagement);
	}
	 ...
	 * @throws NoSuchProjectManagementException if a project management with the primary key could not be found
	 */
	public static ProjectManagement findByPrimaryKey(long projectMgmtId)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectManagementException {

		return getPersistence().findByPrimaryKey(projectMgmtId);
	}
	 ...
	 */
	public static ProjectManagement fetchByPrimaryKey(long projectMgmtId) {
		return getPersistence().fetchByPrimaryKey(projectMgmtId);
	}
	 ...
	 */
	public static List<ProjectManagement> findAll() {
	 ...
	 */
	public static List<ProjectManagement> findAll(int start, int end) {
	...
	public static ProjectManagementPersistence getPersistence() {
		return _persistence;
	}

	private static volatile ProjectManagementPersistence _persistence;
