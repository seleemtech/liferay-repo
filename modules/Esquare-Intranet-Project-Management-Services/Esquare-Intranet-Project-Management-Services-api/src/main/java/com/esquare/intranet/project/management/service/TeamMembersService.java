...
/**
 * Provides the remote service interface for TeamMembers. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Mahammed Seleem
 * @see TeamMembersServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface TeamMembersService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.TeamMembersServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the team members remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TeamMembersServiceUtil} if injection and service tracking are not available.
	 */
