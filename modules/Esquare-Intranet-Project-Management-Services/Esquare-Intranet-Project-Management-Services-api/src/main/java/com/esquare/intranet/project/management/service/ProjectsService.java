...
/**
 * Provides the remote service interface for Projects. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Mahammed Seleem
 * @see ProjectsServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface ProjectsService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.ProjectsServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the projects remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProjectsServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Projects getProject(long projectId) throws PortalException;
