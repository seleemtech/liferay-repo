...
/**
 * Provides the local service utility for Projects. This utility wraps
 * <code>com.esquare.intranet.project.management.service.impl.ProjectsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProjectsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esquare.intranet.project.management.service.impl.ProjectsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Projects _addResourceIdSetting(
		Projects projects, String resourceIdSettings) {

		return getService()._addResourceIdSetting(projects, resourceIdSettings);
	}

	public static Projects addProject(
	 ...
	 */
	public static Projects addProjects(Projects projects) {
		return getService().addProjects(projects);
	}
	 ...
	 */
	public static Projects createProjects(long projectId) {
		return getService().createProjects(projectId);
	}
	 ...
	 */
	public static Projects deleteProjects(long projectId)
		throws PortalException {

		return getService().deleteProjects(projectId);
	}
	 ...
	 * @return the projects that was removed
	 */
	public static Projects deleteProjects(Projects projects) {
		return getService().deleteProjects(projects);
	}
	...
	public static Projects editProject(
	...
	public static Projects fetchProjects(long projectId) {
		return getService().fetchProjects(projectId);
	}
	 ...
	 */
	public static Projects fetchProjectsByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchProjectsByUuidAndGroupId(uuid, groupId);
	}
	...
	public static Projects getProject(long projectId)
		throws com.esquare.intranet.project.management.exception.
			NoSuchProjectsException {
	 ...
	 * @throws PortalException if a projects with the primary key could not be found
	 */
	public static Projects getProjects(long projectId) throws PortalException {
		return getService().getProjects(projectId);
	}
	 ...
	 */
	public static Projects getProjectsByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getProjectsByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Projects> getProjectses(int start, int end) {
		return getService().getProjectses(start, end);
	}
	 ...
	 */
	public static List<Projects> getProjectsesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getProjectsesByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Projects> getProjectsesByUuidAndCompanyId(
		...
		return getService().getProjectsesByUuidAndCompanyId(
	 ...
	 */
	public static int getProjectsesCount() {
		return getService().getProjectsesCount();
	}
	 ...
	 */
	public static Projects updateProjects(Projects projects) {
		return getService().updateProjects(projects);
	}

	public static Projects updateProjects(
		...
		return getService().updateProjects(
	...
	public static ProjectsLocalService getService() {
		return _service;
	}

	private static volatile ProjectsLocalService _service;
