...
/**
 * Provides the local service utility for SendDb. This utility wraps
 * <code>SendOtpService.service.impl.SendDbLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SendDbLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>SendOtpService.service.impl.SendDbLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static SendDb addData(String Name, long mobileNumber) {
		return getService().addData(Name, mobileNumber);
	}
	 ...
	 */
	public static SendDb addSendDb(SendDb sendDb) {
		return getService().addSendDb(sendDb);
	}
	 ...
	 */
	public static SendDb createSendDb(long sendId) {
		return getService().createSendDb(sendId);
	}
	 ...
	 */
	public static SendDb deleteSendDb(long sendId) throws PortalException {
		return getService().deleteSendDb(sendId);
	}
	 ...
	 * @return the send db that was removed
	 */
	public static SendDb deleteSendDb(SendDb sendDb) {
		return getService().deleteSendDb(sendDb);
	}
	...
	public static SendDb fetchSendDb(long sendId) {
		return getService().fetchSendDb(sendId);
	}
	 ...
	 */
	public static SendDb fetchSendDbByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchSendDbByUuidAndCompanyId(uuid, companyId);
	}
	 ...
	 * @throws PortalException if a send db with the primary key could not be found
	 */
	public static SendDb getSendDb(long sendId) throws PortalException {
		return getService().getSendDb(sendId);
	}
	 ...
	 */
	public static SendDb getSendDbByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getSendDbByUuidAndCompanyId(uuid, companyId);
	}
	 ...
	 */
	public static List<SendDb> getSendDbs(int start, int end) {
		return getService().getSendDbs(start, end);
	}
	 ...
	 */
	public static int getSendDbsCount() {
		return getService().getSendDbsCount();
	}
	 ...
	 */
	public static SendDb updateSendDb(SendDb sendDb) {
		return getService().updateSendDb(sendDb);
	}

	public static SendDbLocalService getService() {
		return _service;
	}

	private static volatile SendDbLocalService _service;
