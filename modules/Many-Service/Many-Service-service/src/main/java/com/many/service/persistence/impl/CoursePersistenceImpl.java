...
import com.many.model.CourseTable;
import com.many.model.Student;
import com.many.model.impl.CourseImpl;
import com.many.model.impl.CourseModelImpl;
import com.many.service.persistence.CoursePersistence;
import com.many.service.persistence.CourseUtil;
...
public class CoursePersistenceImpl
	...
	public void activate() {
		...
		courseToStudentTableMapper = TableMapperFactory.getTableMapper(
			"MTM_Students_Courses#courseId", "MTM_Students_Courses",
			"companyId", "courseId", "studentId", this, Student.class);
	...
	public void deactivate() {
		...
		TableMapperFactory.removeTableMapper("MTM_Students_Courses#courseId");
	}
