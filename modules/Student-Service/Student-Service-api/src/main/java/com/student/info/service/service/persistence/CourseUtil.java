...
public class CourseUtil {
	...
	public static Course remove(long courseId)
		throws com.student.info.service.exception.NoSuchCourseException {
	 ...
	 */
	public static List<Course> getTeacherCourses(long pk) {
		return getPersistence().getTeacherCourses(pk);
	}
	 ...
	 */
	public static List<Course> getTeacherCourses(long pk, int start, int end) {
		return getPersistence().getTeacherCourses(pk, start, end);
	}
	...
	public static List<Course> getTeacherCourses(
		...
		return getPersistence().getTeacherCourses(
			pk, start, end, orderByComparator);
	}
