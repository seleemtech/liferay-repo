...
public interface CourseLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.student.info.service.service.impl.CourseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the course local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CourseLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void addTeacherCourse(long teacherId, Course course);

	public void addTeacherCourse(long teacherId, long courseId);

	public void addTeacherCourses(long teacherId, List<Course> courses);
	...
	public void deleteTeacherCourse(long teacherId, Course course);

	public void deleteTeacherCourse(long teacherId, long courseId);

	public void deleteTeacherCourses(long teacherId, List<Course> courses);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Course> getTeacherCourses(long teacherId, int start, int end);
