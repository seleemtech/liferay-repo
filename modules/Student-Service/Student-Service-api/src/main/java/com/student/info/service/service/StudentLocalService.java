...
public interface StudentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.student.info.service.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the student local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StudentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void addTeacherStudent(long teacherId, Student student);

	public void addTeacherStudents(long teacherId, List<Student> students);
	...
	public void deleteTeacherStudent(long teacherId, Student student);

	public void deleteTeacherStudents(long teacherId, List<Student> students);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Student> getTeacherStudents(long teacherId, int start, int end);
