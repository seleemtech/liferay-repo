...
/**
 * Provides the local service interface for Jobinfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JobinfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JobinfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.job.opening.service.service.impl.JobinfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the jobinfo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JobinfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Jobinfo createJob(
			...
			String clientName, Date targetDate, String jobopeningStatus,
			String industry, String jobResource, String hiringManager,
			String positions, Date dateOpened, String jobType,
			String workExperience, String skillSet, String projectStatus,
			long summaryId, long otherId)
	...
	public Jobinfo updateJob(
			...
			String assignedRecruiter, String clientName, Date targetDate,
			String jobopeningStatus, String industry, String jobResource,
			String hiringManager, String positions, Date dateOpened,
