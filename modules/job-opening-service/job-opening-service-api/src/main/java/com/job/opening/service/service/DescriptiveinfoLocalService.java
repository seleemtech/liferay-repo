...
/**
 * Provides the local service interface for Descriptiveinfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DescriptiveinfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DescriptiveinfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.job.opening.service.service.impl.DescriptiveinfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the descriptiveinfo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DescriptiveinfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Descriptiveinfo createDescription(
	...
	public Descriptiveinfo updateDescription(
			String jobDescription, String requirements, String benefits,
			long jobId)
		throws PortalException;
