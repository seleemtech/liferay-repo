...
/**
 * Provides the local service interface for Addressinfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AddressinfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AddressinfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.job.opening.service.service.impl.AddressinfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the addressinfo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AddressinfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Addressinfo deleteAddressinfo(long addressId) throws PortalException;
	...
	public Addressinfo updateAddress(
			String city, String country, String state, long postalCode,
			long jobId)
		throws PortalException;
