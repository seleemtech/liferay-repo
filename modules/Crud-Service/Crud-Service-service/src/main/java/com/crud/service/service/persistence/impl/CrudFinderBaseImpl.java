 ...
 * @generated
 */
public abstract class CrudFinderBaseImpl extends BasePersistenceImpl<Crud> {

	public CrudFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return crudPersistence.getBadColumnNames();
	}
