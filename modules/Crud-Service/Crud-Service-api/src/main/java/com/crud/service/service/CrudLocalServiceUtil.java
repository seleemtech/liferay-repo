 ...
 * <code>com.crud.service.service.impl.CrudLocalServiceImpl</code> and
...
public class CrudLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.crud.service.service.impl.CrudLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Crud addData(String crudName, long crudNo) {
		return getService().addData(crudName, crudNo);
	}
	...
	public static Crud deleteData(long crudId)
		throws com.crud.service.exception.NoSuchCrudException {

		return getService().deleteData(crudId);
	}
	...
	public static List<Crud> findByName(String crudName) {
		return getService().findByName(crudName);
	}
	...
	public static List<Crud> getByCrudId(long crudId) {
		return getService().getByCrudId(crudId);
	}

	public static List<Crud> getByCrudNameAndCrudNo(
		String crudName, long crudNo) {

		return getService().getByCrudNameAndCrudNo(crudName, crudNo);
	}
	...
	public static Crud updateData(long crudId, String crudName, long crudNo) {
		return getService().updateData(crudId, crudName, crudNo);
	}
