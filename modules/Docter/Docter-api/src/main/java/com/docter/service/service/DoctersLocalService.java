...
/**
 * Provides the local service interface for Docters. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DoctersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DoctersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.docter.service.service.impl.DoctersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the docters local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DoctersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Docters updatedocter(
			long docterId, String docterName, ServiceContext serviceContext)
		throws PortalException;
