 ...
 */
@Component(service = StealthKartBetaLayoutsInitializer.class)
public class StealthKartBetaLayoutsInitializer {

	public void initialize(ServiceContext serviceContext) throws Exception {
		System.out.println("coming to layout initializer");
	...
	@Reference(
		target = "(site.initializer.key=" + StealthkartBetaSiteInitializer.KEY + ")"
	)
