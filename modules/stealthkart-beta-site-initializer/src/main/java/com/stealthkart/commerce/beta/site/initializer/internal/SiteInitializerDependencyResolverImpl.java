 ...
 */
@Component(
        property = "site.initializer.key=" + StealthkartBetaSiteInitializer.KEY,
...
public class SiteInitializerDependencyResolverImpl
    ...
    public String getKey() {
        return StealthkartBetaSiteInitializer.KEY;
    }

    private static final String _DEPENDENCIES_PATH =
            "com/stealthkart/commerce/beta/site/initializer/internal/dependencies/";
