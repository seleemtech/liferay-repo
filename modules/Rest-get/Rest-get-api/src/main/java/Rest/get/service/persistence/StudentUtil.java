...
package Rest.get.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws Rest.get.exception.NoSuchStudentException {
	 ...
	 * @return the matching students
	 */
	public static List<Student> findByFindbyId(long studentId) {
		return getPersistence().findByFindbyId(studentId);
	}
	 ...
	 * @return the range of matching students
	 */
	public static List<Student> findByFindbyId(
		long studentId, int start, int end) {

		return getPersistence().findByFindbyId(studentId, start, end);
	}
	...
	public static List<Student> findByFindbyId(
		...
		return getPersistence().findByFindbyId(
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByFindbyId_First(
			long studentId, OrderByComparator<Student> orderByComparator)
		throws Rest.get.exception.NoSuchStudentException {

		return getPersistence().findByFindbyId_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByFindbyId_First(
		long studentId, OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByFindbyId_First(
			studentId, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByFindbyId_Last(
			long studentId, OrderByComparator<Student> orderByComparator)
		throws Rest.get.exception.NoSuchStudentException {

		return getPersistence().findByFindbyId_Last(
			studentId, orderByComparator);
	}
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByFindbyId_Last(
		long studentId, OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByFindbyId_Last(
			studentId, orderByComparator);
	}
	 ...
	 * @param studentId the student ID
	 */
	public static void removeByFindbyId(long studentId) {
		getPersistence().removeByFindbyId(studentId);
	}
	 ...
	 * @return the number of matching students
	 */
	public static int countByFindbyId(long studentId) {
		return getPersistence().countByFindbyId(studentId);
	}
