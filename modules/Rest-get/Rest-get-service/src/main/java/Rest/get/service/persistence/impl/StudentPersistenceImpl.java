...
package Rest.get.service.persistence.impl;

import Rest.get.exception.NoSuchStudentException;
import Rest.get.model.Student;
import Rest.get.model.StudentTable;
import Rest.get.model.impl.StudentImpl;
import Rest.get.model.impl.StudentModelImpl;
import Rest.get.service.persistence.StudentPersistence;
import Rest.get.service.persistence.StudentUtil;
import Rest.get.service.persistence.impl.constants.STDPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByFindbyId;
	private FinderPath _finderPathWithoutPaginationFindByFindbyId;
	private FinderPath _finderPathCountByFindbyId;
	 ...
	 */
	@Override
	public List<Student> findByFindbyId(long studentId) {
		return findByFindbyId(
	 ...
	 */
	@Override
	public List<Student> findByFindbyId(long studentId, int start, int end) {
		return findByFindbyId(studentId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Student> findByFindbyId(
		long studentId, int start, int end,
		OrderByComparator<Student> orderByComparator) {

		return findByFindbyId(studentId, start, end, orderByComparator, true);
	}
	...
	public List<Student> findByFindbyId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByFindbyId;
				finderArgs = new Object[] {studentId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByFindbyId;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_FINDBYID_STUDENTID_2);
	 ...
	 */
	@Override
	public Student findByFindbyId_First(
			long studentId, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByFindbyId_First(studentId, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByFindbyId_First(
		long studentId, OrderByComparator<Student> orderByComparator) {

		List<Student> list = findByFindbyId(studentId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Student findByFindbyId_Last(
			long studentId, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByFindbyId_Last(studentId, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByFindbyId_Last(
		long studentId, OrderByComparator<Student> orderByComparator) {

		int count = countByFindbyId(studentId);

		if (count == 0) {
			return null;
		}

		List<Student> list = findByFindbyId(
	 ...
	 */
	@Override
	public void removeByFindbyId(long studentId) {
		for (Student student :
				findByFindbyId(
					studentId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByFindbyId(long studentId) {
		FinderPath finderPath = _finderPathCountByFindbyId;
	...
	private static final String _FINDER_COLUMN_FINDBYID_STUDENTID_2 =
		"student.studentId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByFindbyId = new FinderPath(
	...
	@Override
	@Reference(
		target = STDPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = STDPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
