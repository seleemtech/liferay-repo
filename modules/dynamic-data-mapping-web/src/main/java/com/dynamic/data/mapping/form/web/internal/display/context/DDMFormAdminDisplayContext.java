...
package com.dynamic.data.mapping.form.web.internal.display.context;
...
import com.rms.dynamic.data.mapping.form.web.internal.configuration.DDMFormWebConfiguration;
import com.rms.dynamic.data.mapping.form.web.internal.constants.DDMFormWebKeys;
import com.rms.dynamic.data.mapping.form.web.internal.display.context.helper.DDMFormAdminRequestHelper;
import com.rms.dynamic.data.mapping.form.web.internal.display.context.helper.FormInstancePermissionCheckerHelper;
import com.rms.dynamic.data.mapping.form.web.internal.display.context.util.DDMFormAdminActionDropdownItemsProvider;
...
import com.rms.dynamic.data.mapping.form.web.internal.search.DDMFormInstanceRowChecker;
import com.rms.dynamic.data.mapping.form.web.internal.search.DDMFormInstanceSearch;
...
public class DDMFormAdminDisplayContext {
	...
	public CreationMenu getCreationMenu() {
		if (!_formInstancePermissionCheckerHelper.isShowAddButton()) {
			System.out.println("Non Creating  Menu url");
			return null;
		}
		System.out.println("Creating  Menu url");
	...
	private UnsafeConsumer<DropdownItem, Exception> _getAddFormDropdownItem() {
		return dropdownItem -> {
			...
			ThemeDisplay themeDisplay =
				(ThemeDisplay)httpServletRequest.getAttribute(
					WebKeys.THEME_DISPLAY);
System.out.println("Before Setting url");
			...
			System.out.println("After Setting url");
			dropdownItem.setLabel(
