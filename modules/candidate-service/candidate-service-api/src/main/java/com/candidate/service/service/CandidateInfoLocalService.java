...
/**
 * Provides the local service interface for CandidateInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CandidateInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CandidateInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.candidate.service.service.impl.CandidateInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the candidate info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CandidateInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CandidateInfo addOrUpdateCandidate(
		...
		String houseNumber, String website, ServiceContext serviceContext);
	...
	public CandidateInfo deleteCandidate(long candidateId)
