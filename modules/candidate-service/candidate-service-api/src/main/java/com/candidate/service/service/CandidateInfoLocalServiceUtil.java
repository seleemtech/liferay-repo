...
/**
 * Provides the local service utility for CandidateInfo. This utility wraps
 * <code>com.candidate.service.service.impl.CandidateInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CandidateInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.candidate.service.service.impl.CandidateInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CandidateInfo addCandidateInfo(CandidateInfo candidateInfo) {
		return getService().addCandidateInfo(candidateInfo);
	}

	public static CandidateInfo addOrUpdateCandidate(
		...
		return getService().addOrUpdateCandidate(
	 ...
	 */
	public static CandidateInfo createCandidateInfo(long candidateId) {
		return getService().createCandidateInfo(candidateId);
	}
	...
	public static CandidateInfo deleteCandidate(long candidateId)
	 ...
	 */
	public static CandidateInfo deleteCandidateInfo(
		CandidateInfo candidateInfo) {

		return getService().deleteCandidateInfo(candidateInfo);
	}
	 ...
	 */
	public static CandidateInfo deleteCandidateInfo(long candidateId)
		throws PortalException {

		return getService().deleteCandidateInfo(candidateId);
	}
	...
	public static CandidateInfo fetchCandidateInfo(long candidateId) {
		return getService().fetchCandidateInfo(candidateId);
	}
	 ...
	 */
	public static CandidateInfo fetchCandidateInfoByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchCandidateInfoByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 * @throws PortalException if a candidate info with the primary key could not be found
	 */
	public static CandidateInfo getCandidateInfo(long candidateId)
		throws PortalException {

		return getService().getCandidateInfo(candidateId);
	}
	 ...
	 */
	public static CandidateInfo getCandidateInfoByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getCandidateInfoByUuidAndCompanyId(uuid, companyId);
	}
	 ...
	 */
	public static List<CandidateInfo> getCandidateInfos(int start, int end) {
		return getService().getCandidateInfos(start, end);
	}
	 ...
	 */
	public static int getCandidateInfosCount() {
		return getService().getCandidateInfosCount();
	}
	 ...
	 */
	public static CandidateInfo updateCandidateInfo(
		CandidateInfo candidateInfo) {

		return getService().updateCandidateInfo(candidateInfo);
	}

	public static CandidateInfoLocalService getService() {
		return _service;
	}

	private static volatile CandidateInfoLocalService _service;
