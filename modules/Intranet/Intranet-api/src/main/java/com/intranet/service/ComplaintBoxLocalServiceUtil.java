...
/**
 * Provides the local service utility for ComplaintBox. This utility wraps
 * <code>com.intranet.service.impl.ComplaintBoxLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ComplaintBoxLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.intranet.service.impl.ComplaintBoxLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ComplaintBox addComplaintBox(ComplaintBox complaintBox) {
		return getService().addComplaintBox(complaintBox);
	}
	 ...
	 */
	public static ComplaintBox createComplaintBox(long fooId) {
		return getService().createComplaintBox(fooId);
	}
	 ...
	 */
	public static ComplaintBox deleteComplaintBox(ComplaintBox complaintBox) {
		return getService().deleteComplaintBox(complaintBox);
	}
	 ...
	 */
	public static ComplaintBox deleteComplaintBox(long fooId)
		throws PortalException {

		return getService().deleteComplaintBox(fooId);
	}
	...
	public static ComplaintBox fetchComplaintBox(long fooId) {
		return getService().fetchComplaintBox(fooId);
	}
	 ...
	 * @throws PortalException if a complaint box with the primary key could not be found
	 */
	public static ComplaintBox getComplaintBox(long fooId)
		throws PortalException {

		return getService().getComplaintBox(fooId);
	}
	 ...
	 */
	public static List<ComplaintBox> getComplaintBoxes(int start, int end) {
		return getService().getComplaintBoxes(start, end);
	}
	 ...
	 */
	public static int getComplaintBoxesCount() {
		return getService().getComplaintBoxesCount();
	}
	 ...
	 */
	public static ComplaintBox updateComplaintBox(ComplaintBox complaintBox) {
		return getService().updateComplaintBox(complaintBox);
	}

	public static ComplaintBoxLocalService getService() {
		return _service;
	}

	private static volatile ComplaintBoxLocalService _service;
