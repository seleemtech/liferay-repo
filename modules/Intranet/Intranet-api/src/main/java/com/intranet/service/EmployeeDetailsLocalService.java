...
public interface EmployeeDetailsLocalService
	...
	public EmployeeDetails addEmployee(
			...
			String passportNumber, String aadhar, Date joiningDate, Date dob,
			boolean maritalstatus, Date anniversaryDate, long fileEntryId)
	...
	public EmployeeDetails deleteEmployee(long employeeID)
