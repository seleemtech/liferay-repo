...
/**
 * Provides the local service utility for Graduation. This utility wraps
 * <code>com.intranet.service.impl.GraduationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GraduationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.intranet.service.impl.GraduationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Graduation addGraduation(Graduation graduation) {
		return getService().addGraduation(graduation);
	}
	 ...
	 */
	public static Graduation createGraduation(String graduationCode) {
		return getService().createGraduation(graduationCode);
	}
	 ...
	 */
	public static Graduation deleteGraduation(Graduation graduation) {
		return getService().deleteGraduation(graduation);
	}
	 ...
	 */
	public static Graduation deleteGraduation(String graduationCode)
		throws PortalException {

		return getService().deleteGraduation(graduationCode);
	}
	...
	public static Graduation fetchGraduation(String graduationCode) {
		return getService().fetchGraduation(graduationCode);
	}
	 ...
	 * @throws PortalException if a graduation with the primary key could not be found
	 */
	public static Graduation getGraduation(String graduationCode)
		throws PortalException {

		return getService().getGraduation(graduationCode);
	}
	 ...
	 */
	public static List<Graduation> getGraduations(int start, int end) {
		return getService().getGraduations(start, end);
	}
	 ...
	 */
	public static int getGraduationsCount() {
		return getService().getGraduationsCount();
	}
	 ...
	 */
	public static Graduation updateGraduation(Graduation graduation) {
		return getService().updateGraduation(graduation);
	}

	public static GraduationLocalService getService() {
		return _service;
	}

	private static volatile GraduationLocalService _service;
