...
public interface SpecializationLocalService
	...
	public Specialization createSpecialization(long spCode);
	...
	public Specialization deleteSpecialization(long spCode)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Specialization fetchSpecialization(long spCode);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Specialization getSpecialization(long spCode) throws PortalException;
