 ...
 * <code>com.intranet.service.impl.SpecializationLocalServiceImpl</code> and
...
public class SpecializationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.intranet.service.impl.SpecializationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Specialization addSpecialization(
	 ...
	 */
	public static Specialization createSpecialization(long spCode) {
		return getService().createSpecialization(spCode);
	}
	 ...
	 */
	public static Specialization deleteSpecialization(long spCode)
		throws PortalException {

		return getService().deleteSpecialization(spCode);
	}
	 ...
	 * @return the specialization that was removed
	 */
	public static Specialization deleteSpecialization(
		Specialization specialization) {
	...
	public static Specialization fetchSpecialization(long spCode) {
		return getService().fetchSpecialization(spCode);
	}
	 ...
	 * @throws PortalException if a specialization with the primary key could not be found
	 */
	public static Specialization getSpecialization(long spCode)
		throws PortalException {

		return getService().getSpecialization(spCode);
	}
	 ...
	 */
	public static List<Specialization> getSpecializations(int start, int end) {
	 ...
	 */
	public static Specialization updateSpecialization(
		Specialization specialization) {
	...
	private static volatile SpecializationLocalService _service;
