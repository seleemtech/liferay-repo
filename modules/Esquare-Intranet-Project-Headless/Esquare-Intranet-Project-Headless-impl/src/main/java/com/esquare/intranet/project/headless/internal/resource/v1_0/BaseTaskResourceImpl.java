...
public abstract class BaseTaskResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/esquare/intranet/project/headless/v1.0/get-task/{projectId}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/get-task/{projectId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<Task> getGetTasksProjectPage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/esquare/intranet/project/headless/v1.0/post-task' -d $'{"description": ___, "developmentTeam": ___, "developmentTeamIds": ___, "id": ___, "name": ___, "projectCode": ___, "projectId": ___, "status": ___, "taskEndDate": ___, "taskStartDate": ___, "testerTeam": ___, "testerTeamIds": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Task")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/post-task")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/esquare/intranet/project/headless/v1.0/update-task' -d $'{"description": ___, "developmentTeam": ___, "developmentTeamIds": ___, "id": ___, "name": ___, "projectCode": ___, "projectId": ___, "status": ___, "taskEndDate": ___, "taskStartDate": ___, "testerTeam": ___, "testerTeamIds": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Task")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/update-task")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
