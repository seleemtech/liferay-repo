...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "EsquareIntranetProjectHeadless REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "EsquareIntranetProjectHeadless", version = "v1.0")
)
@Path("/v1.0")
