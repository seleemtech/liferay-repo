...
public interface TaskResource {
	...
	public HttpInvoker.HttpResponse getGetTasksProjectPageHttpResponse(
			Long projectId)
		throws Exception;

	public Task postPostTask(Task task) throws Exception;

	public HttpInvoker.HttpResponse postPostTaskHttpResponse(Task task)
		throws Exception;

	public Task postUpdateTask(Task task) throws Exception;

	public HttpInvoker.HttpResponse postUpdateTaskHttpResponse(Task task)
		throws Exception;
	...
	public static class TaskResourceImpl implements TaskResource {
		...
		public Page<Task> getGetTasksProjectPage(Long projectId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getGetTasksProjectPageHttpResponse(projectId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/esquare/intranet/project/headless/v1.0/get-task/{projectId}");
		...
		public Task postPostTask(Task task) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postPostTaskHttpResponse(
				task);
		...
		public HttpInvoker.HttpResponse postPostTaskHttpResponse(Task task)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/esquare/intranet/project/headless/v1.0/post-task");
		...
		public Task postUpdateTask(Task task) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postUpdateTaskHttpResponse(
				task);
		...
		public HttpInvoker.HttpResponse postUpdateTaskHttpResponse(Task task)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/esquare/intranet/project/headless/v1.0/update-task");
