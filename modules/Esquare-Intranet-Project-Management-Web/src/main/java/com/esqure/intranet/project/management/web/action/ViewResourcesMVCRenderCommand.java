 ...
 * @Description This class is used for redirect to view resource jsp.
...
@Component(
        property = {
                ...
                "mvc.command.name=/project_admin/view_resources"
        },
        service = MVCRenderCommand.class
)
public class ViewResourcesMVCRenderCommand
    ...
    public String render(
        ...
        return "/project/view_resources.jsp";
    }
