 ...
 * @Description This class is used for redirect to adding resource jsp.
...
@Component(
        property = {
                ...
                "mvc.command.name=/project_admin/add_resources"
        },
        service = MVCRenderCommand.class
)
public class AddResourcesMVCRenderCommand
    ...
    public String render(
        ...
        return "/project/add_resources.jsp";
    }
