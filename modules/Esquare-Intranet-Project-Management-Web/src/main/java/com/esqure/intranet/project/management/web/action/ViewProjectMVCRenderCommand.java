 ...
 * @Description This class is used for redirect to project view jsp.
...
@Component(
        property = {
                ...
                "mvc.command.name=/project_admin/view_single_project"
        },
        service = MVCRenderCommand.class
)
public class ViewProjectMVCRenderCommand
    ...
    public String render(
        ...
        return "/project/view_single_project.jsp";
    }
