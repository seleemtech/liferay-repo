...
/**
 * The arguments resolver class for retrieving value from Register.
 *
...
@Component(
	immediate = true,
	service = {RegisterModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class RegisterModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= registerModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return RegisterImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return RegisterTable.INSTANCE.getTableName();
	}
