...
public interface RegisterLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.rigistration.service.service.impl.RegisterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the register local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RegisterLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Register addData(
